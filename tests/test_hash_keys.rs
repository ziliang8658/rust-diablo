/// 测试哈希密钥计算
use rust_diablo::resources::mpq_format::{hash_string, HashType, initialize_crypt_table};
...
fn test_hash_table_keys() {
    ...
    println!("\n=== Hash Keys ===");
    println!("hash_table_key:  {} (0x{:08X})", hash_table_key, hash_table_key);
    println!("Expected:        {} (0x{:08X})", 3283040112u32, 3283040112u32);
    println!();
    println!("block_table_key: {} (0x{:08X})", block_table_key, block_table_key);
    println!("Expected:        {} (0x{:08X})", 3968054179u32, 3968054179u32);
