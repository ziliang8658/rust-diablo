...
use rust_diablo::resources::{ResourceManager, ColorTransform};
...
fn main() -> Result<()> {
    ...
    println!("  Size: {}x{}", town.background_width, town.background_height);
    let walkable = town.get_walkable_area();
    println!("  Walkable area: {}x{} at ({},{})", 
